...
import com.cllasify.cllasify.Adaptor.Adaptor_JoinUserGroup;
...
//        });
        ...
        esv_groupSearchView =view.findViewById(R.id.esv_groupSearchView);
        rv_AllJoinGroup =view.findViewById(R.id.rv_AllJoinGroup);
        rv_AllJoinUser =view.findViewById(R.id.rv_AllJoinUser);

        btn_Users =view.findViewById(R.id.btn_Users);
        btn_School =view.findViewById(R.id.btn_School);
        ...
        rv_AllJoinGroup.setLayoutManager(new LinearLayoutManager(getContext()));
        rv_AllJoinUser.setLayoutManager(new LinearLayoutManager(getContext()));
...
//        bottomSheetDialoglogin.setCancelable(false);
        ...
        rv_ShowClass.setLayoutManager(new LinearLayoutManager(getContext()));

        listGrpClassList = new ArrayList<>();
        showGrpClassList = new Adaptor_ShowGrpClass(getContext(), listGrpClassList);
