...
public class Adaptor_ShowGrpMemberEditRollNumberList extends RecyclerView.Adapter<Adaptor_ShowGrpMemberEditRollNumberList.MyViewHolder> {
    ...
    public Adaptor_ShowGrpMemberEditRollNumberList(Context context, List<Class_Student_Details> mDatalistNew) {
