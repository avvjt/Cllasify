...
public class Adaptor_JoinUserGroup extends RecyclerView.Adapter<Adaptor_JoinUserGroup.MyViewHolder> {
    ...
    public interface  OnItemClickListener{
        ...
        void createGroupDialog(String userName,String UserId);
    ...
    public Adaptor_JoinUserGroup(Context context, List<Class_Group> mDatalistNew) {
...
//                            String groupPushId = user.getGroupCategory();
                            ...
                            mListener.createGroupDialog(userName,userId);
                        }
                    }
                }
            });
