...
public class Adaptor_Friends extends RecyclerView.Adapter<Adaptor_Friends.MyViewHolder> {
    ...
    public interface  OnItemClickListener{
        ...
        void showChildChatAdaptor(int position, String groupName, String subGroupName, String groupPushId, String subGroupPushID,String frndUserId);
    }
    public void setOnItemClickListener(OnItemClickListener listener){
        mListener=listener;
    }

    public Adaptor_Friends(Context context, List<Class_Group> mDatalistNew) {
                ...
                public void onClick(View v) {
                    if (mListener != null) {
                        ...
                        if (position != RecyclerView.NO_POSITION) {
                            ...
                            String frndUserId = user.getUserId();

                            mListener.showChildChatAdaptor(position, groupName, subGroupName,groupPushId,subGroupPushID,frndUserId);
                        }
                    }
                }
            });
