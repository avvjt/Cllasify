...
public class Adaptor_lvl2QueryGroup extends RecyclerView.Adapter<Adaptor_lvl2QueryGroup.MyViewHolder> {
    ...
    public interface OnItemClickListener {
        ...
        void viewChildGroup2(int position, String groupName, String groupPushId, String groupClassName, String groupCreatorName, String groupUserID, String groupClassSubjects);

        void viewChildGroup3(int position, String groupName, String groupPushId, String groupClassName, String groupCreatorName, String groupUserID, String groupClassSubjects);

        void viewChildGroup4(int position, String groupName, String groupPushId, String groupClassName, String groupCreatorName, String groupUserID, String groupClassSubjects);

        void viewChildGroup5(int position, String groupName, String groupPushId, String groupClassName, String groupCreatorName, String groupUserID, String groupClassSubjects);

        void viewChildGroup6(int position, String groupName, String groupPushId, String groupClassName, String groupCreatorName, String groupUserID, String groupClassSubjects);

        void viewChildGroup7(int position, String groupName, String groupPushId, String groupClassName, String groupCreatorName, String groupUserID, String groupClassSubjects);

        void viewChildGroup8(int position, String groupName, String groupPushId, String groupClassName, String groupCreatorName, String groupUserID, String groupClassSubjects);

        void viewChildGroup9(int position, String groupName, String groupPushId, String groupClassName, String groupCreatorName, String groupUserID, String groupClassSubjects);
    }
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
        ...
        holder.tv_Group2.setBackgroundColor(selected_position == position ? context.getColor(R.color.colorPrimary) : Color.TRANSPARENT);
        holder.tv_Group3.setBackgroundColor(selected_position == position ? context.getColor(R.color.colorPrimary) : Color.TRANSPARENT);
        holder.tv_Group4.setBackgroundColor(selected_position == position ? context.getColor(R.color.colorPrimary) : Color.TRANSPARENT);
        holder.tv_Group5.setBackgroundColor(selected_position == position ? context.getColor(R.color.colorPrimary) : Color.TRANSPARENT);
        holder.tv_Group6.setBackgroundColor(selected_position == position ? context.getColor(R.color.colorPrimary) : Color.TRANSPARENT);
        holder.tv_Group7.setBackgroundColor(selected_position == position ? context.getColor(R.color.colorPrimary) : Color.TRANSPARENT);
        holder.tv_Group8.setBackgroundColor(selected_position == position ? context.getColor(R.color.colorPrimary) : Color.TRANSPARENT);
        holder.tv_Group9.setBackgroundColor(selected_position == position ? context.getColor(R.color.colorPrimary) : Color.TRANSPARENT);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.getChildrenCount() > 0) {
                    ...
                    if (snapshot.child("tgroupClassSubjects").exists()) {
                        ...
                        if (GroupClassSubjects.equals(group2)) {
                            holder.tv_Group2.setBackgroundColor(context.getColor(R.color.colorPrimary));
                        } else {
                            holder.tv_Group1.setBackgroundColor(context.getColor(R.color.transparent));
                            holder.tv_Group3.setBackgroundColor(context.getColor(R.color.transparent));
                            holder.tv_Group4.setBackgroundColor(context.getColor(R.color.transparent));
                            holder.tv_Group5.setBackgroundColor(context.getColor(R.color.transparent));
                            holder.tv_Group6.setBackgroundColor(context.getColor(R.color.transparent));
                        ...
                        if (GroupClassSubjects.equals(group3)) {
                            holder.tv_Group3.setBackgroundColor(context.getColor(R.color.colorPrimary));
                        } else {
                            holder.tv_Group1.setBackgroundColor(context.getColor(R.color.transparent));
                            holder.tv_Group2.setBackgroundColor(context.getColor(R.color.transparent));
                            holder.tv_Group4.setBackgroundColor(context.getColor(R.color.transparent));
                        ...
                        if (GroupClassSubjects.equals(group4)) {
                            holder.tv_Group4.setBackgroundColor(context.getColor(R.color.colorPrimary));
                        } else {
                            holder.tv_Group1.setBackgroundColor(context.getColor(R.color.transparent));
                            holder.tv_Group2.setBackgroundColor(context.getColor(R.color.transparent));
                            holder.tv_Group3.setBackgroundColor(context.getColor(R.color.transparent));
                        ...
                        if (GroupClassSubjects.equals(group5)) {
                            holder.tv_Group5.setBackgroundColor(context.getColor(R.color.colorPrimary));
                        } else {
                            holder.tv_Group1.setBackgroundColor(context.getColor(R.color.transparent));
                            holder.tv_Group2.setBackgroundColor(context.getColor(R.color.transparent));
                            holder.tv_Group3.setBackgroundColor(context.getColor(R.color.transparent));
                        ...
                        if (GroupClassSubjects.equals(group6)) {
                            holder.tv_Group6.setBackgroundColor(context.getColor(R.color.colorPrimary));
                        } else {
                            holder.tv_Group1.setBackgroundColor(context.getColor(R.color.transparent));
                            holder.tv_Group2.setBackgroundColor(context.getColor(R.color.transparent));
                            holder.tv_Group3.setBackgroundColor(context.getColor(R.color.transparent));
                        ...
                        if (GroupClassSubjects.equals(group7)) {
                            holder.tv_Group7.setBackgroundColor(context.getColor(R.color.colorPrimary));
                        } else {
                            holder.tv_Group1.setBackgroundColor(context.getColor(R.color.transparent));
                            holder.tv_Group2.setBackgroundColor(context.getColor(R.color.transparent));
                            holder.tv_Group3.setBackgroundColor(context.getColor(R.color.transparent));
                        ...
                        if (GroupClassSubjects.equals(group8)) {
                            holder.tv_Group8.setBackgroundColor(context.getColor(R.color.colorPrimary));
                        } else {
                            holder.tv_Group1.setBackgroundColor(context.getColor(R.color.transparent));
                            holder.tv_Group2.setBackgroundColor(context.getColor(R.color.transparent));
                            holder.tv_Group3.setBackgroundColor(context.getColor(R.color.transparent));
                        ...
                        if (GroupClassSubjects.equals(group9)) {
                            holder.tv_Group9.setBackgroundColor(context.getColor(R.color.colorPrimary));
                        } else {
                            holder.tv_Group1.setBackgroundColor(context.getColor(R.color.transparent));
                            holder.tv_Group2.setBackgroundColor(context.getColor(R.color.transparent));
                            holder.tv_Group3.setBackgroundColor(context.getColor(R.color.transparent));
                ...
                public void onClick(View v) {
                    if (mListener != null) {
                        ...
                        if (position != RecyclerView.NO_POSITION) {
                            ...
                            tv_Group2.setBackgroundColor(context.getColor(R.color.colorPrimary));
                            changeCOor.child("tgroupClassSubjects").setValue(groupClassSubjects);


                            mListener.viewChildGroup2(position, groupName, groupPushId, groupClassName, groupCreatorName, groupUserID, groupClassSubjects);
                        }
                    }
                }
            });
                ...
                public void onClick(View v) {
                    if (mListener != null) {
                        ...
                        if (position != RecyclerView.NO_POSITION) {
                            ...
                            String groupClassName = user.getUserEmailId();
                            String groupUserID = user.getUserId();
                            String groupClassSubjects = user.getGroup3();

//                            notifyItemChanged(selected_position);
//                            selected_position=getAdapterPosition();
//                            notifyItemChanged(selected_position);
                            changeCOor.child("tgroupClassSubjects").setValue(groupClassSubjects);
                            tv_Group3.setBackgroundColor(context.getColor(R.color.colorPrimary));
                            mListener.viewChildGroup3(position, groupName, groupPushId, groupClassName, groupCreatorName, groupUserID, groupClassSubjects);
                        }
                    }
                }
            });
                ...
                public void onClick(View v) {
                    if (mListener != null) {
                        ...
                        if (position != RecyclerView.NO_POSITION) {
                            ...
                            String groupClassName = user.getUserEmailId();
                            String groupUserID = user.getUserId();
                            String groupClassSubjects = user.getGroup4();


                            changeCOor.child("tgroupClassSubjects").setValue(groupClassSubjects);

                            tv_Group4.setBackgroundColor(context.getColor(R.color.colorPrimary));
                            mListener.viewChildGroup4(position, groupName, groupPushId, groupClassName, groupCreatorName, groupUserID, groupClassSubjects);
                        }
                    }
                }
            });
                ...
                public void onClick(View v) {
                    if (mListener != null) {
                        ...
                        if (position != RecyclerView.NO_POSITION) {
                            ...
                            String groupClassName = user.getUserEmailId();
                            String groupUserID = user.getUserId();
                            String groupClassSubjects = user.getGroup5();
                            changeCOor.child("tgroupClassSubjects").setValue(groupClassSubjects);

                            tv_Group5.setBackgroundColor(context.getColor(R.color.colorPrimary));
                            mListener.viewChildGroup5(position, groupName, groupPushId, groupClassName, groupCreatorName, groupUserID, groupClassSubjects);
                        }
                    }
                }
            });
                ...
                public void onClick(View v) {
                    if (mListener != null) {
                        ...
                        if (position != RecyclerView.NO_POSITION) {
                            ...
                            String groupClassName = user.getUserEmailId();
                            String groupUserID = user.getUserId();
                            String groupClassSubjects = user.getGroup6();
...
//                            notifyItemChanged(selected_position);
                            ...
                            tv_Group6.setBackgroundColor(context.getColor(R.color.colorPrimary));
                            mListener.viewChildGroup6(position, groupName, groupPushId, groupClassName, groupCreatorName, groupUserID, groupClassSubjects);
                        }
                    }
                }
            });
                ...
                public void onClick(View v) {
                    if (mListener != null) {
                        ...
                        if (position != RecyclerView.NO_POSITION) {
                            ...
                            String groupClassName = user.getUserEmailId();
                            String groupUserID = user.getUserId();
                            String groupClassSubjects = user.getGroup7();
...
//                            notifyItemChanged(selected_position);
                            ...
                            tv_Group7.setBackgroundColor(context.getColor(R.color.colorPrimary));
                            mListener.viewChildGroup7(position, groupName, groupPushId, groupClassName, groupCreatorName, groupUserID, groupClassSubjects);
                        }
                    }
                }
            });
                ...
                public void onClick(View v) {
                    if (mListener != null) {
                        ...
                        if (position != RecyclerView.NO_POSITION) {
                            ...
                            String groupClassName = user.getUserEmailId();
                            String groupUserID = user.getUserId();
                            String groupClassSubjects = user.getGroup8();

                            changeCOor.child("tgroupClassSubjects").setValue(groupClassSubjects);

                            tv_Group8.setBackgroundColor(context.getColor(R.color.colorPrimary));
                            mListener.viewChildGroup8(position, groupName, groupPushId, groupClassName, groupCreatorName, groupUserID, groupClassSubjects);
                        }
                    }
                }
            });
                ...
                public void onClick(View v) {
                    if (mListener != null) {
                        ...
                        if (position != RecyclerView.NO_POSITION) {
                            ...
                            String groupClassName = user.getUserEmailId();
                            String groupUserID = user.getUserId();
                            String groupClassSubjects = user.getGroup9();
...
//                            notifyItemChanged(selected_position);
                            ...
                            tv_Group9.setBackgroundColor(context.getColor(R.color.colorPrimary));
                            mListener.viewChildGroup9(position, groupName, groupPushId, groupClassName, groupCreatorName, groupUserID, groupClassSubjects);
                        }
                    }
                }
            });
