...
public class TestLocation extends BottomSheetDialogFragment {
...
//        ImageButton btn_Cancel = getActivity().findViewById(R.id.btn_Cancel);
//        TextView tv_subTitle = view.findViewById(R.id.tv_subTitle);
//        TextView tv_SettingTitle = view.findViewById(R.id.tv_SettingTitle);
        AutoCompleteTextView et_NewDetails =  view.findViewById(R.id.actv);
//        Button btn_Submit =  getActivity().findViewById(R.id.btn_Submit);

        et_NewDetails.setAdapter(adapter);


//        tv_subTitle.setText("Enter new " );
//        tv_SettingTitle.setText("Please update ");
